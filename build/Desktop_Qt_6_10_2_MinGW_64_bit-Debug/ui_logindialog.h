...
public:
    ...
    void setupUi(QDialog *LoginDialog)
    {
        ...
        LoginDialog->setLayoutDirection(Qt::LayoutDirection::LeftToRight);
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/res/tx.jpg")));
        ...
        horizontalLayout->setContentsMargins(5, 5, 5, 7);
