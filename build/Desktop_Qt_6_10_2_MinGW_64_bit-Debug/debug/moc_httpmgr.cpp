...
template <> constexpr inline auto HttpMgr::qt_create_metaobjectdata<qt_meta_tag_ZN7HttpMgrE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(ReqId, QString, ErrorCodes)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { QMetaType::QString, 5 }, { 0x80000000 | 6, 7 },
        }}),
        // Signal 'sig_http_finish'
        QtMocHelpers::SignalData<void(ReqId, QString, ErrorCodes, Modules)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 }, { QMetaType::QString, 5 }, { 0x80000000 | 6, 7 }, { 0x80000000 | 9, 10 },
        }}),
...
void HttpMgr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->sig_reg_mod_finish((*reinterpret_cast<std::add_pointer_t<ReqId>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<ErrorCodes>>(_a[3]))); break;
        case 1: _t->sig_http_finish((*reinterpret_cast<std::add_pointer_t<ReqId>>(_a[1])),(*reinterpret_cast<std::add_pointer_t<QString>>(_a[2])),(*reinterpret_cast<std::add_pointer_t<ErrorCodes>>(_a[3])),(*reinterpret_cast<std::add_pointer_t<Modules>>(_a[4]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (HttpMgr::*)(ReqId , QString , ErrorCodes )>(_a, &HttpMgr::sig_reg_mod_finish, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (HttpMgr::*)(ReqId , QString , ErrorCodes , Modules )>(_a, &HttpMgr::sig_http_finish, 1))
            return;
    }
}
